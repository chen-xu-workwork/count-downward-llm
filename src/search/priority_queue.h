...
class AbstractQueue {
public:
    typedef std::pair<ap_float, Value> Entry;

    AbstractQueue() {}
    virtual ~AbstractQueue() {}

    virtual void push(ap_float key, const Value &value) = 0;
    virtual Entry pop() = 0;
...
public:
    ...
    virtual void push(ap_float key, const Value &value) {
...
public:
    ...
    void push(ap_float key, const Value &value) {
