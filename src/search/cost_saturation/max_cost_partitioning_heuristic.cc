...
static void log_info_about_stored_lookup_tables(
    ...
    g_log << "Stored lookup tables: " << num_stored_lookup_tables << "/"
                 << num_lookup_tables << " = "
    ...
    g_log << "Stored values: " << num_stored_values << "/"
                 << num_total_values << " = "
...
MaxCostPartitioningHeuristic::MaxCostPartitioningHeuristic(
    ...
    g_log << "Useful abstractions: " << num_useful_abstractions << "/"
                 << num_abstractions << " = "
...
ap_float MaxCostPartitioningHeuristic::compute_heuristic(const GlobalState &global_state) {
