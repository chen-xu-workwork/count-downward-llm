...
class CostPartitioningHeuristic {
    ...
    struct LookupTable {
        ...
        LookupTable(int abstraction_id, std::vector<ap_float> &&h_values)
    ...
    void merge_h_values(int abstraction_id, std::vector<ap_float> &&h_values);

public:
    void add_h_values(int abstraction_id, std::vector<ap_float> &&h_values);
    ...
    */
    ap_float compute_heuristic(const std::vector<int> &abstract_state_ids) const;
