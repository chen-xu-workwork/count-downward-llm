...
for var_order, vo_name in [("GOAL_CG_LEVEL", "g_cg_l")]:
    for num_first, nf_name in [("false", "")]:
        for lim, lim_name in [(10000000, "10M"), (50000000, "50M"), (100000000, "100M"), (200000000, "200M")]:
...
exp.add_fetcher("data/2024-05-17-state-registry-lookup-eval/", name="fetch-baselines", merge=True)
