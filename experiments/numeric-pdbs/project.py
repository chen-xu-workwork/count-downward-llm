...
SUITE_NUMERIC_TRANSFORMED = [
    "depots", "depots-sym", 
    "fn-counters-small_instances", "plant-watering", 
    "pn_domain", "rover-transformed", 
    "rover-unit", "sailing", "satellite", "sym-counters"
]
...
SUITE_NUMERIC_IPC23_RT = [
    "delivery", "drone", "expedition", "hydropower", "mprime",
    "rover-ipc23", "settlersnumeric", "sugar", "zenotravel-ipc23"
]

SUITE_NUMERIC_IPC23_TRANSFORMED = [
    "counters", "ext-plant-watering", "sailing-ipc23",
]
