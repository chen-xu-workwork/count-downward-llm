...
SUITE_NUMERIC_TRANSFORMED = [
    "depots", "depots-unit", "depots_sym", "farmland", "farmland-sat", 
    "fn-counters-small_instances", "plant-watering", "plant-watering-sat", 
    "pn_domain", "rover", "rover-unit", "sailing", "sailing-sat", "satellite", 
    "satellite-unit", "sym-counters"
]

SUITE_NUMERIC_IPC23 = [
    "delivery", "drone", "expedition", "hydropower", "markettrader", "mprime",
    "rover", "settlersnumeric", "sugar", "zenotravel"
]
