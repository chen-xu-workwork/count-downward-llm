...
lmcut_configs = [
    "astar(numeric_ipdb(max_time=150, use_lmcut=1, f_layer_offset_ratio=-1.0, extend_abstract_state_space=1, blind_if_no_goal=1))",
    "astar(numeric_ipdb(max_time=150, use_lmcut=1, f_layer_offset_ratio=-1.0, extend_abstract_state_space=0, blind_if_no_goal=1))",
    "astar(numeric_ipdb(max_time=150, use_lmcut=1, f_layer_offset_ratio=-1.0, extend_abstract_state_space=1, blind_if_no_goal=0))",
    "astar(numeric_ipdb(max_time=150, use_lmcut=1, f_layer_offset_ratio=-1.0, extend_abstract_state_space=0, blind_if_no_goal=0))",
]
